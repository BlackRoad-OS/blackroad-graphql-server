...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/blackroad-graphql-server.git
cd blackroad-graphql-server

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/blackroad-graphql-server.git
